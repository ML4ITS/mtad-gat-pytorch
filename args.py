...
def get_parser():
    ...
    parser.add_argument("--resample_rate", type=float, default=1)
    parser.add_argument("--cut", type=float, default=1)
    parser.add_argument("--train_test_split", type=float, default=1)
    parser.add_argument("--no_anomaly_train", type=float, default=True)
